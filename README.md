...
## Domaine Métier et Description
Le projet Flotte de véhicules est une application Java permettant de gérer une flotte de véhicules et les missions associées.
L’application assure le suivi des véhicules (immatriculation, état, kilométrage, maintenance) ainsi que la gestion des chauffeurs et de leurs disponibilités.
